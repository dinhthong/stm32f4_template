...
class CLed
{
  ...
  void on(){GPIO_WriteBit(_port,_pin,Bit_SET);}    //turn on LED
  void off(){GPIO_WriteBit(_port,_pin,Bit_RESET);} //turn off LED
  void toggle(){GPIO_ToggleBits(_port,_pin);}            //toggle LED
public:
